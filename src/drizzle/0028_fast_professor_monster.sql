...
CREATE VIEW "public"."hotmart_course_lesson_count" AS (select "hotmart_course_modules"."course", count("hotmart_course_lessons"."id") as "count" from "hotmart_course_lessons" left join "hotmart_course_modules" on "hotmart_course_modules"."id" = "hotmart_course_lessons"."module" left join "hotmart_video_assets" on "hotmart_video_assets"."lesson" = "hotmart_course_lessons"."id" left join "training_assets" on "hotmart_video_assets"."asset" = "training_assets"."id" where "training_assets"."deleted_at" is null group by "hotmart_course_modules"."course");--> statement-breakpoint
